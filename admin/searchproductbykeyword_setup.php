...
/**
 * 	\file		admin/searchproductbykeyword.php
...
require_once '../lib/searchproductbykeyword.lib.php';
 ...
 * View
 */
$page_name = "searchproductbykeywordSetup";
...
$head = searchproductbykeywordAdminPrepareHead();
dol_fiche_head(
    $head,
    'settings',
    $langs->trans("Module104929Name"),
    0,
