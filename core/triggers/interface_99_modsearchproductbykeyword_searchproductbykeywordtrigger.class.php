...
/**
 * 	\file		core/triggers/interface_99_modMyodule_searchproductbykeywordtrigger.class.php
 * 	\ingroup	searchproductbykeyword
 * 	\brief		Sample trigger
 * 	\remarks	You can create other triggers by copying this one
 * 				- File name should be either:
 * 					interface_99_modSearchproductbykeyword_Mytrigger.class.php
 ...
 * Trigger class
 */
class Interfacesearchproductbykeywordtrigger
{
